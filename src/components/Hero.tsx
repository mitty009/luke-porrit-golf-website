...
type HeroProps = {
    /** Path to the hero background video (MP4, WebM, etc.) */
    videoSrc?: string;
    /** Optional static image fallback for mobile or performance */
...
export default function Hero({
    ...
    //   subtitle = "Unlock your full potential with expert coaching from Luke Porritt. Master your swing, sharpen your short game, and lower your score.",
