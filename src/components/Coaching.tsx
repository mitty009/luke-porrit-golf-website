...
export default function Coaching() {
  const services = [
    {
      title: "Private Lesson (60 mins)",
      desc: "One-on-one coaching with video analysis & improvement plan.",
    },
    {
      title: "Short Game Clinic",
      desc: "Small-group focus on wedges, putting, and scoring from 100m in.",
    },
    {
      title: "Junior Program",
      desc: "Weekly coaching pathway designed for junior golfers.",
    },
  ];

  return (
    <section id="coaching" className="max-w-6xl mx-auto px-4 py-20">
